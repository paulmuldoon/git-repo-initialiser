...
The script will create a .gitignore file if one does not already exist, then add itself to gitignore to prevent it from being pushed to the remote. The reference to the script file will be removed from the .gitignore if you choose to delete the script in the last step of the setup process.
